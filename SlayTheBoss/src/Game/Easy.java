...
public class Easy extends Encounter {
    static String [] questText = {"Foraging", "Berry gathering", "Item delivery to another town", "Kill a slime"};
    final int questDamage = 25;
    final int questAtk = 5;
    final int questGold = 10;
    ...
    public void damageCalc(){
        System.out.println("easy damage calc called");
